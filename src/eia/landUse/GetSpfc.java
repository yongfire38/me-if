...
public class GetSpfc {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 1) {
			...
			File file = new File(JsonParser.getProperty("file_path") + "LanduseService_getSpfc_" + strDate + ".dat");
			...
			try {
				...
				if (resultCode.equals("00")) {
					...
					for (int i = 0; i < spfcs.size(); i++) {
						...
						while (iter.hasNext()) {
							...
							if (keyname.equals("spfcNm")) {
								spfcNm = spfc.get(keyname).toString();
							}
							if (keyname.equals("bfeSpfcAr")) {
								bfeSpfcAr = spfc.get(keyname).toString();
							}
							if (keyname.equals("aftSpfcAr")) {
								aftSpfcAr = spfc.get(keyname).toString();
							}
					...
					File f = new File(JsonParser.getProperty("file_path") + "LanduseService_getSpfc_" + strDate + ".dat");

	...
	public static void main(String[] args) throws Exception {
			...
			if (args.length == 0) {
				...
				String service_url = JsonParser
						.getProperty("envrnAffcEvlDraftDsplayInfoInqireService_getStrategyDraftPblancDsplayListInfoInqire_url");
				...
				StringBuffer perCd = new StringBuffer(" "); // 사전환경성 검토 코드
				StringBuffer bizSeq = new StringBuffer(" "); // 사업고유 번호

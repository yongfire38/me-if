						...
						for (int i = 0; i < ivstgGbs.size(); i++) {
							...
							for (int r = 0; r < ivstgs.size(); r++) {
								...
								for (int f = 0; f < odrs.size(); f++) {
									...
									// 3개는 공통적인 바깥 배열의 값이므로 Iterator로 받아 올 수
									// 없다..
									// String ivstgGb = " ";
									// String ivstgSpotNm = " ";
									// String adres = " ";
									...
									try {
										...
										pw.write(hcnVal); // 시안화수소
										pw.write("|^");
										pw.write(gmenoPm1024hr); // 공사시
																	// PM-10_24시간평균
										pw.write("|^");
										pw.write(gmenoPm10Year); // 공사시
																	// PM-10_연평균
										pw.write("|^");
										pw.write(gmenoPm2524hr); // 공사시
																	// PM-2.5_24시간평균
										pw.write("|^");
										pw.write(gmenoPm25Year); // 공사시
																	// PM-2.5_연평균
										pw.write("|^");
										pw.write(gmenoNo21hr); // 공사시 NO2_1시간평균
										pw.write("|^");
										pw.write(gmenoNo224hr); // 공사시
																// NO2_24시간평균
										pw.write("|^");
										pw.write(gmenoNo2Year); // 공사시 NO2_연평균
										pw.write("|^");
										pw.write(umenoPm1024hr); // 운영시
																	// PM-10_24시간평균
										pw.write("|^");
										pw.write(umenoPm10Year); // 운영시
																	// PM-10_연평균
										pw.write("|^");
										pw.write(umenoPm2524hr); // 운영시
																	// PM-2.5_24시간평균
										pw.write("|^");
										pw.write(umenoPm25Year); // 운영시
																	// PM-2.5_연평균
										pw.write("|^");
										pw.write(umenoSo21hr); // 운영시 SO2_1시간평균
										pw.write("|^");
										pw.write(umenoSo224hr); // 운영시
																// SO2_24시간평균
										pw.write("|^");
										pw.write(umenoSo2Year); // 운영시 SO2_연평균
										pw.write("|^");

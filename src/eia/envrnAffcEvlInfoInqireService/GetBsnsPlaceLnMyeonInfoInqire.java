	...
	public static void main(String[] args) throws Exception {
			...
			try {
				...
				if (args.length == 3) {
					...
					/*if(json.indexOf("</") > -1){
						System.out.print("공공데이터 서버 비 JSON 응답, centerx :" + args[0]+", centery :" + args[1]);
						json = "{\"response\":{\"header\":{\"resultCode\":\"00\",\"resultMsg\":\"NORMAL SERVICE.\"},\"body\":{\"items\":\"\"}}}";
					}*/

					JSONObject count_obj = JsonParser.parseEiaJson_obj(service_url, service_key, String.valueOf(pageNo), args[0], args[1]);
					...
					for (int i = 1; i <= pageCount; i++) {
						...
						JSONObject obj = JsonParser.parseEiaJson_obj(service_url, service_key, String.valueOf(i), args[0], args[1]);
				...
				e.printStackTrace();
				System.out.println("클래스명 : "+ Thread.currentThread().getStackTrace()[1].getClassName() +", centerx :" + args[0]+", centery :" + args[1]);
				System.exit(-1);
			}

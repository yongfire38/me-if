...
public class GetSlr {
	...
	final static Logger logger = Logger.getLogger(GetSlr.class);
	...
	public static void main(String[] args) {
		...
		if (args.length == 1) {
			...
			File file = new File(JsonParser.getProperty("file_path") + "GeologicalService_getSlr_" + strDate + ".dat");
			...
			try {
				...
				if (resultCode.equals("00")) {
					...
					File f = new File(JsonParser.getProperty("file_path") + "GeologicalService_getSlr_" + strDate + ".dat");

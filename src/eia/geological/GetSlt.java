...
public class GetSlt {
	...
	final static Logger logger = Logger.getLogger(GetSlt.class);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 1) {
			...
			File file = new File(JsonParser.getProperty("file_path") + "GeologicalService_getSlt_" + strDate + ".dat");
			...
			try {
				...
				if (resultCode.equals("00")) {
					...
					for (int i = 0; i < slts.size(); i++) {
						...
						while (iter.hasNext()) {
							...
							if (keyname.equals("sltGrad")) {
								sltGrad = slt.get(keyname).toString();
							}
							if (keyname.equals("sltArea")) {
								sltArea = slt.get(keyname).toString();
							}
							if (keyname.equals("sltAreaRate")) {
								sltAreaRate = slt.get(keyname).toString();
							}
					...
					File f = new File(JsonParser.getProperty("file_path") + "GeologicalService_getSlt_" + strDate + ".dat");

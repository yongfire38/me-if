...
public class GetModel {
	...
	final static Logger logger = Logger.getLogger(GetModel.class);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 1) {
			...
			File file = new File(JsonParser.getProperty("file_path") + "MaritimeService_getModel_" + strDate + ".dat");
			...
			try {
				...
				if (resultCode.equals("00")) {
					...
					File f = new File(JsonParser.getProperty("file_path") + "MaritimeService_getModel_" + strDate + ".dat");

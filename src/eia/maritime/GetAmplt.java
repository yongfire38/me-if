...
public class GetAmplt {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 1) {
			...
			// step 1.파일의 첫 행 작성
			File file = new File(JsonParser.getProperty("file_path") + "EIA/TIF_EIA_15_" + mgtNo + ".dat");
			...
			try {
				...
				if (resultCode.equals("00")) {
					...
					TransSftp.transSftp(JsonParser.getProperty("file_path") + "EIA/TIF_EIA_15_" + mgtNo + ".dat", "EIA");

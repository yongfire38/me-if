...
public class CustomSearch_delimiter_test {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 1) {
			...
			File file = new File(JsonParser.getProperty("file_path") + "SNS/TIF_SNS_301_delimiter_test.dat");
			...
			TransSftp.transSftp(JsonParser.getProperty("file_path") + "SNS/TIF_SNS_301_delimiter_test.dat", "SNS");

			...
			try {
				...
				if (args.length == 6 || args.length == 7) {
					...
					if (args[0].length() == 8 && args[1].length() == 2 && args[2].length() == 8
						...
						if(args.length == 6){
							file = new File(JsonParser.getProperty("file_path") + "WRI/TIF_WRI_13.dat");
						...
						JSONObject count_obj = JsonParser.parseWriJson_excll_obj(service_url, service_key, String.valueOf(pageNo), args[0],
								args[1], args[2], args[3], args[4], args[5]);
						...
						for (int i = 1; i <= pageCount; i++) {
							...
							JSONObject obj = JsonParser.parseWriJson_excll_obj(service_url, service_key, String.valueOf(i), args[0],
									args[1], args[2], args[3], args[4], args[5]);

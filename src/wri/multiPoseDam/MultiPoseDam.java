...
public class MultiPoseDam {
	...
	final static Logger logger = Logger.getLogger(MultiPoseDam.class);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 4) {
			...
			if (args[0].length() == 8 && args[1].length() == 8 && args[2].length() == 8 && args[3].length() == 2) {
				...
				// step 1.파일의 첫 행 작성
				File file = new File(JsonParser.getProperty("file_path") + "WRI/TIF_WRI_09_" + args[0] + "_" + args[1]
				...
				TransSftp.transSftp(JsonParser.getProperty("file_path") + "WRI/TIF_WRI_09_" + args[0] + "_" + args[1]

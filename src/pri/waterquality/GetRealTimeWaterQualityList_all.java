...
public class GetRealTimeWaterQualityList_all {
	...
	final static Logger logger = Logger.getLogger(GetRealTimeWaterQualityList_all.class);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 0) {
			...
			String service_url = JsonParser.getProperty("PRI_WaterQualityService_getRealTimeWaterQualityList_url");

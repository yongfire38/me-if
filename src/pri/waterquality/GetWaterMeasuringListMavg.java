...
public class GetWaterMeasuringListMavg {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 1) {
			...
			String service_url = JsonParser.getProperty("PRI_WaterQualityService_getWaterMeasuringListMavg_url");
			...
			if (file.exists()) {
				...
				try {
					...
					pw.write("|^");
					pw.write("itemCloa"); // 측정값(클로로필-a(Chlorophyll-a)) (단위 :
											// ㎎/L)
					pw.write("|^");
			...
			try {
				...
				int numOfRows = ((Long) getWaterMeasuringListMavgList.get("numOfRows")).intValue();
				int totalCount = ((Long) getWaterMeasuringListMavgList.get("totalCount")).intValue();
			...
			StringBuffer itemAmnt = new StringBuffer(" "); // 측정값(유량) (단위 :
															// ㎥/sec)
			StringBuffer itemTemp = new StringBuffer(" "); // 측정값(수온) (단위 : ℃)
			StringBuffer itemPh = new StringBuffer(" "); // 측정값(수소이온농도(pH))
			StringBuffer itemDoc = new StringBuffer(" "); // 측정값(용존산소(DO)) (단위 :
															// ㎎/L)
			StringBuffer itemBod = new StringBuffer(" "); // 측정값(생물화학적산소요구량(BOD))
															// (단위 : ㎎/L)
			StringBuffer itemCod = new StringBuffer(" "); // 측정값(화학적산소요구량(COD))
															// (단위 : ㎎/L)
			StringBuffer itemSs = new StringBuffer(" "); // 측정값(부유물질(SS)) (단위 :
															// ㎎/L)
			StringBuffer itemTcoli = new StringBuffer(" "); // 측정값(총대장균군)(단위 :
															// 총대장균군수/100㎖)
			StringBuffer itemTn = new StringBuffer(" "); // 측정값(총질소(T-N)) (단위 :
															// ㎎/L)
			StringBuffer itemTp = new StringBuffer(" "); // 측정값(총인(T-P)) (단위 :
															// ㎎/L)
			StringBuffer itemCd = new StringBuffer(" "); // 측정값(카드뮴(Cd)) (단위 :
															// ㎎/L)
			StringBuffer itemCn = new StringBuffer(" "); // 측정값(시안(CN)) (단위 :
															// ㎎/L)
			StringBuffer itemPb = new StringBuffer(" "); // 측정값(납(Pb)) (단위 :
															// ㎎/L)
			StringBuffer itemCr6 = new StringBuffer(" "); // 측정값(6가크롬(Cr6+)) (단위
															// : ㎎/L)
			StringBuffer itemAs = new StringBuffer(" "); // 측정값(비소(As)) (단위 :
															// ㎎/L)
			StringBuffer itemHg = new StringBuffer(" "); // 측정값(수은(Hg)) (단위 :
															// ㎎/L)
			StringBuffer itemCu = new StringBuffer(" "); // 측정값(구리(Cu)) (단위 :
															// ㎎/L)
			...
			StringBuffer itemMn = new StringBuffer(" "); // 측정값(용해성 망간(Mn)) (단위
															// : ㎎/L)
			StringBuffer itemTrans = new StringBuffer(" "); // 측정값(투명도) (단위 :
															// ㎎/L)
			StringBuffer itemCloa = new StringBuffer(" "); // 측정값(클로로필-a(Chlorophyll-a))
															// (단위 : ㎎/L)
			StringBuffer itemCl = new StringBuffer(" "); // 측정값(염소이온(Cl-)) (단위 :
															// ㎎/L)
			StringBuffer itemZn = new StringBuffer(" "); // 측정값(아연(Zn)) (단위 :
															// ㎎/L)
			StringBuffer itemCr = new StringBuffer(" "); // 측정값(크롬(Cr)) (단위 :
															// ㎎/L)
			StringBuffer itemFe = new StringBuffer(" "); // 측정값(용해성 철(Fe)) (단위 :
															// ㎎/L)
			StringBuffer itemPhenol = new StringBuffer(" "); // 측정값(페놀류(phenols))
																// (단위 : ㎎/L)
			StringBuffer itemNhex = new StringBuffer(" "); // 측정값(노말헥산추출물질) (단위
															// : ㎎/L)
			StringBuffer itemEc = new StringBuffer(" "); // 측정값(전기전도도(EC)) (단위 :
															// µS/㎝)
			...
			StringBuffer itemNh3n = new StringBuffer(" "); // 측정값(암모니아성
															// 질소(NH3-N)) (단위 :
															// ㎎/L)
			StringBuffer itemEcoli = new StringBuffer(" "); // 측정값(분원성대장균군) (단위
															// : 분원성대장균군수/100㎖)
			StringBuffer itemPop = new StringBuffer(" "); // 측정값(인산염 인(PO4-P))
															// (단위 : ㎎/L)
			StringBuffer itemDtn = new StringBuffer(" "); // 측정값(용존총질소(DTN)) (단위
															// : ㎎/L)
			StringBuffer itemDtp = new StringBuffer(" "); // 측정값(용존총인(DTP)) (단위
															// : ㎎/L)
			StringBuffer itemFl = new StringBuffer(" "); // 측정값(불소(F)) (단위 :
															// ㎎/L)
			StringBuffer itemCol = new StringBuffer(" "); // 측정값(색도) (단위 : 도)
			StringBuffer itemCcl4 = new StringBuffer(" "); // 측정값(사염화탄소) (단위 :
															// ㎎/L)
			StringBuffer itemDceth = new StringBuffer(" "); // 측정값(1,2-다이클로로에탄)
															// (단위 : ㎎/L)
			StringBuffer itemDcm = new StringBuffer(" "); // 측정값(다이클로로메탄) (단위 :
															// ㎎/L)
			StringBuffer itemBenzene = new StringBuffer(" "); // 측정값(벤젠) (단위 :
																// ㎎/L)
			StringBuffer itemChcl3 = new StringBuffer(" "); // 측정값(클로로포름) (단위 :
															// ㎎/L)
			StringBuffer itemToc = new StringBuffer(" "); // 측정값(총유기탄소(TOC)) (단위
															// : ㎎/L)
			StringBuffer itemDehp = new StringBuffer(" "); // 측정값(다이에틸헥실프탈레이트(DEHP))
															// (단위 : ㎎/L)
			StringBuffer itemAntimon = new StringBuffer(" "); // 측정값(안티몬(Sb))
																// (단위 : ㎎/L)
			StringBuffer itemDiox = new StringBuffer(" "); // 측정값(1,4-다이옥세인) (단위
															// : ㎎/L)
			StringBuffer itemHcho = new StringBuffer(" "); // 측정값(포름알데히드) (단위 :
															// ㎎/L)
			StringBuffer itemHcb = new StringBuffer(" "); // 측정값(헥사클로로벤젠) (단위 :
															// ㎎/L)

...
public class GetSgisDrinkWaterList {
	...
	final static Logger logger = Logger.getLogger(GetSgisDrinkWaterList.class);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 0) {
			...
			try {
				...
				pw.write("rowno"); // 순번
				pw.write("|^");
				pw.write("legacyCodeNo"); // 지점번호
				pw.write("|^");
				pw.write("spotNm"); // 지점명
				pw.write("|^");
				pw.write("spotStdCode"); // 지점표준코드
				pw.write("|^");
				pw.write("infoCreatlnsttNm"); // 정보생성기관명칭
				pw.write("|^");
				pw.write("doNm"); // 시도
				pw.write("|^");
				pw.write("ctyNm"); // 시군구
				...
				pw.write("adres"); // 주소
				pw.write("|^");
				pw.write("admcode"); // 법정동코드
				pw.write("|^");
				pw.write("ablAt"); // 폐지여부
				pw.write("|^");
				pw.write("ablDe"); // 폐지일자
				pw.write("|^");
				pw.write("dayAvg"); // 1일평균이용자수
				pw.write("|^");
				pw.write("charge"); // 담당자
				pw.write("|^");
				pw.write("insDate"); // 설치일자
				pw.write("|^");
				pw.write("delYn"); // 삭제여부(추정)
				pw.write("|^");
				pw.write("office"); // 담당자명
				pw.write("|^");
				pw.write("officeTel"); // 담당자연락처
				pw.write("|^");
				pw.write("buildingNo"); // 건물번호
				pw.write("|^");
				pw.write("locJibun"); // 소재지_지번
				pw.write("|^");
				pw.write("commt"); // 비고
				pw.write("|^");
				pw.write("yyyy"); // 년
				...
				pw.write("period"); // 분기
				pw.write("|^");
				pw.write("samp_date"); // 채수일자
				pw.write("|^");
				pw.write("inspCheck"); // 검사여부
				pw.write("|^");
				pw.write("unlnspDesc"); // 미검사사유
				pw.write("|^");
				pw.write("insp_date"); // 검사일자
				pw.write("|^");
				pw.write("acceptYn"); // 적합여부
				pw.write("|^");
				pw.write("suit"); // 적합
				pw.write("|^");
				pw.write("unsuit"); // 부적합
				pw.write("|^");
				pw.write("itemGenbaclow"); // 일반세균저온
				pw.write("|^");
				pw.write("itemGenbacmid"); // 일반세균중온
				pw.write("|^");
				pw.write("itemTotbac"); // 총대장균군
				pw.write("|^");
				pw.write("itemBac"); // 대장균
				pw.write("|^");
				pw.write("itemFestr"); // 분원성대장균군
				pw.write("|^");
				pw.write("itemBranfungus"); // 분원성연쇄상구균
				pw.write("|^");
				pw.write("itemGrgungus"); // 녹농균
				pw.write("|^");
				pw.write("itemSalmol"); // 살모넬라
				pw.write("|^");
				pw.write("itemSegel"); // 쉬겔라
				pw.write("|^");
				pw.write("itemSulfungus"); // 아황산환원혐기성포자형성균
				pw.write("|^");
				pw.write("itemYersinia"); // 여시니아균
				pw.write("|^");
				pw.write("itemPb"); // 납
				pw.write("|^");
				pw.write("itemF"); // 불소
				...
				pw.write("itemCr6"); // 크롬
				pw.write("|^");
				pw.write("itemNo3am"); // 암모니아성질소
				pw.write("|^");
				pw.write("itemNo3n"); // 질산성질소
				pw.write("|^");
				pw.write("itemCd"); // 카드뮴
				pw.write("|^");
				pw.write("itemBoron"); // 보론
				pw.write("|^");
				pw.write("itemBro3"); // 브론산염
				pw.write("|^");
				pw.write("itemUran"); // 우라늄
				pw.write("|^");
				pw.write("itemPhenol"); // 페놀
				pw.write("|^");
				pw.write("itemDiazn"); // 다이아지논
				pw.write("|^");
				pw.write("itemParat"); // 파라티온
				pw.write("|^");
				pw.write("itemPenitro"); // 페니트로티온
				pw.write("|^");
				pw.write("itemCarbaryl"); // 카바릴
				pw.write("|^");
				pw.write("itemTcet"); // 1.1.1-트리클로로에탄
				pw.write("|^");
				pw.write("itemTece"); // 테트라클로로에틸렌
				pw.write("|^");
				pw.write("itemTce"); // 트리클로로에틸렌
				pw.write("|^");
				pw.write("itemDcm"); // 디클로로메탄
				pw.write("|^");
				pw.write("itemBenzene"); // 벤젠
				pw.write("|^");
				pw.write("itemToluene"); // 톨루엔
				pw.write("|^");
				pw.write("itemEtilben"); // 에틸벤젠
				pw.write("|^");
				pw.write("itemXylene"); // 자일렌
				pw.write("|^");
				pw.write("itemDce"); // 1.1디클로로에틸렌
				pw.write("|^");
				pw.write("itemCcl4"); // 사염화탄소
				pw.write("|^");
				pw.write("itemDbcp"); // 1,2-디브로모-3-클로로프로판
				pw.write("|^");
				pw.write("itemC4h8o2"); // 1.4-다이옥산
				pw.write("|^");
				pw.write("itemGradient"); // 경도
				pw.write("|^");
				pw.write("itemKmn"); // 과망간산칼륨소비량
				pw.write("|^");
				pw.write("itemSmell"); // 냄새
				pw.write("|^");
				pw.write("itemColor"); // 색도
				pw.write("|^");
				pw.write("itemCu"); // 동
				pw.write("|^");
				pw.write("itemAbs"); // 세제(음이온계면활성제)
				pw.write("|^");
				pw.write("itemPh"); // 수소이온농도
				pw.write("|^");
				pw.write("itemZn"); // 아연
				pw.write("|^");
				pw.write("itemCl"); // 염소이온
				pw.write("|^");
				pw.write("itemFe"); // 철
				pw.write("|^");
				pw.write("itemMn"); // 망간
				pw.write("|^");
				pw.write("itemMuddy"); // 탁도
				pw.write("|^");
				pw.write("itemSo42"); // 황산이온
				pw.write("|^");
				pw.write("itemAl"); // 알루미늄
				pw.write("|^");
				pw.write("inspRst"); // 부적합항목
				pw.write("|^");
				pw.write("failDesc"); // 부적합시 조치사항
				pw.write("|^");

...
public class Wikindwater {
	...
	final static Logger logger = Logger.getLogger(Wikindwater.class);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 3) {
			...
			if (args[1].length() == 6 && args[2].length() == 6) {
				...
				// step 1.파일의 첫 행 작성
				File file = new File(JsonParser.getProperty("file_path") + "WRS/TIF_WRS_21_" + args[0] + "_" + args[1]
						+ "_" + args[2] + ".dat");
				...
				try {
					...
					pw.write("|^");
					pw.write("item1"); // COD(mg/L) 원수
					pw.write("|^");
					pw.write("item2"); // KMnO4소비량(mg/L) 침전수
					pw.write("|^");
					pw.write("item3"); // TDS(mg/L) 원수
					pw.write("|^");
					pw.write("item4"); // TDS(mg/L) 침전수
					pw.write("|^");
					pw.write("item5"); // 경도(mg/L) 원수
					pw.write("|^");
					pw.write("item6"); // 경도(mg/L) 침전수
					pw.write("|^");
				...
				StringBuffer item1 = new StringBuffer(" "); // COD(mg/L) 원수
				StringBuffer item2 = new StringBuffer(" "); // KMnO4소비량(mg/L)
															// 침전수
				StringBuffer item3 = new StringBuffer(" "); // TDS(mg/L) 원수
				StringBuffer item4 = new StringBuffer(" "); // TDS(mg/L) 침전수
				StringBuffer item5 = new StringBuffer(" "); // 경도(mg/L) 원수
				StringBuffer item6 = new StringBuffer(" "); // 경도(mg/L) 침전수
				...
				TransSftp.transSftp(JsonParser.getProperty("file_path") + "WRS/TIF_WRS_21_" + args[0] + "_" + args[1]
						+ "_" + args[2] + ".dat", "WRS");

...
public class Dailindwater {
	...
	final static Logger logger = Logger.getLogger(Dailindwater.class);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 3) {
			...
			if (args[1].length() == 8 && args[2].length() == 8) {
				...
				// step 1.파일의 첫 행 작성
				File file = new File(JsonParser.getProperty("file_path") + "WRS/TIF_WRS_19_" + args[0] + "_" + args[1]
						+ "_" + args[2] + ".dat");
				...
				TransSftp.transSftp(JsonParser.getProperty("file_path") + "WRS/TIF_WRS_19_" + args[0] + "_" + args[1]
						+ "_" + args[2] + ".dat", "WRS");

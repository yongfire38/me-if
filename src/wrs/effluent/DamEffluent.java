			...
			try {
				...
				if (args.length == 2) {
					...
					if (args[0].length() == 4) {
						...
						/*if(json.indexOf("</") > -1){
							System.out.print("공공데이터 서버 비 JSON 응답  , stdt :" + args[0] + ": damcd :" + args[1]);
				...
				e.printStackTrace();
				System.out.println("클래스명 : "+ Thread.currentThread().getStackTrace()[1].getClassName() + ", stdt :" + args[0] + ": damcd :" + args[1]);
				System.exit(-1);
			}

				...
				if (args[0].equals("_tset")) {
					...
					while (rs.next()) {
						...
						System.out.println("spce_id::" + spce_id + "::examin_year::" + examin_year + "::tme::" + tme
								...
								+ "::partclr_matter::" + partclr_matter + "::wethr::" + wethr + "::photo_file_ttle::"
								+ photo_file_ttle + "::observ_cn::" + observ_cn + "::observ_de::" + observ_de
								+ "::observ_place::" + observ_place + "::ecsystm_ty::" + ecsystm_ty + "::cnfirm_mth::"
								+ cnfirm_mth + "::grid_no::" + grid_no + "::fml_eng_ttle::" + fml_eng_ttle
								+ "::fml_korean_ttle::" + fml_korean_ttle + "::ordr_eng_ttle::" + ordr_eng_ttle
								+ "::ordr_korean_ttle::" + ordr_korean_ttle + "::spcs_schlshp_ttle::"
								+ spcs_schlshp_ttle + "::mml_observ_observ_qy::" + mml_observ_observ_qy
								+ "::mml_observ_den_qy::" + mml_observ_den_qy + "::mml_observ_etc_marks_dc::"
								+ mml_observ_etc_marks_dc + "::mml_observ_exct_qy::" + mml_observ_exct_qy
								+ "::mml_observ_prar_qy::" + mml_observ_prar_qy + "::mml_observ_crcs_qy::"
								+ mml_observ_crcs_qy + "::mml_observ_ankr_qy::" + mml_observ_ankr_qy
								+ "::mml_observ_mark_qy::" + mml_observ_mark_qy + "::mml_observ_hair_qy::"
								+ mml_observ_hair_qy + "::mml_observ_capt_qy::" + mml_observ_capt_qy
								+ "::mml_examin_cryn_qy::" + mml_examin_cryn_qy + "::geom::" + geom);
					...
					while (rs.next()) {
						...
						// geom =
						// JsonParser.colWrite_String_eic(rs.getString(36));
